...
import { CloudProviderDefaultSelector } from '../components/panels/SettingsPanel';

let update: ReturnType<typeof vi.fn>;

beforeEach(() => {
  update = vi.fn().mockResolvedValue({} as Workspace);
  vi.spyOn(api.workspaces, 'update').mockImplementation(update as never);
});
