...
- [ ] **Collect prospective outcomes and complete provenance.** Use the new collector and join on fresh exports. Record authoritative request rounds and backend model versions. Treat exposure, opens, and submitted reviews as separate observations.
