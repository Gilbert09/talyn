...
export const FEATURE_FLAGS = {
   ...
   */
  /** Released Priority mode survives a flag outage. The candidate has a separate gate. */
  reviewPriority: {
  ...
  reviewRankingCandidate: {
    posthogKey: 'review-ranking-candidate-v1',
    envOverride: 'REVIEW_RANKING_CANDIDATE_ENABLED',
    fallback: false,
    description: 'Fixed shared ranking candidate for the production experiment',
    availability: 'gated',
    releaseScopes: [],
  },
