...
export const MCP_CATALOG: readonly McpCatalogEntry[] = [
  ...
  {
    logo: MCP_CATALOG_LOGOS['figma'],
    handle: "figma",
    title: "Figma",
    summary: "Read designs, components and layout details.",
    url: "https://mcp.figma.com/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['render'],
    handle: "render",
    title: "Render",
    summary: "Manage services, inspect logs and trigger deployments.",
    url: "https://mcp.render.com/mcp",
    authKind: "bearer",
    credentialLabel: "Render API key",
    notes: 'Use a Render API key. Browser sign-in requires a registered Render OAuth client.',
  },
  {
    logo: MCP_CATALOG_LOGOS['netlify'],
    handle: "netlify",
    title: "Netlify",
    summary: "Manage sites, deployments and project settings.",
    url: "https://netlify-mcp.netlify.app/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['buildkite'],
    handle: "buildkite",
    title: "Buildkite",
    summary: "Inspect pipelines, builds, jobs and test results.",
    url: "https://mcp.buildkite.com/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['axiom'],
    handle: "axiom",
    title: "Axiom",
    summary: "Query logs and manage monitors and dashboards.",
    url: "https://mcp.axiom.co/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['clickup'],
    handle: "clickup",
    title: "ClickUp",
    summary: "Manage tasks, documents and workspaces.",
    url: "https://mcp.clickup.com/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['monday'],
    handle: "monday",
    title: "monday.com",
    summary: "Manage boards, items and project workflows.",
    url: "https://mcp.monday.com/mcp",
    authKind: "bearer",
    oauth: true,
    credentialLabel: "monday.com personal API token",
  },
  {
    logo: MCP_CATALOG_LOGOS['attio'],
    handle: "attio",
    title: "Attio",
    summary: "Search and update contacts, companies and CRM records.",
    url: "https://mcp.attio.com/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['todoist'],
    handle: "todoist",
    title: "Todoist",
    summary: "Manage tasks, projects, due dates and comments.",
    url: "https://ai.todoist.net/mcp",
    authKind: "bearer",
    oauth: true,
  },
  {
    logo: MCP_CATALOG_LOGOS['amplitude'],
    handle: "amplitude",
    title: "Amplitude (US)",
    summary: "Explore product analytics, charts and tracking plans in the US region.",
  ...
  },
  {
    ...
    handle: "amplitude-eu",
    title: "Amplitude (EU)",
    summary: "Explore product analytics, charts and tracking plans in the EU region.",
  ...
  },
  {
    ...
    handle: "cloudflare",
    title: "Cloudflare",
    summary: "Search and use the Cloudflare API across your account.",
  ...
  {
    logo: MCP_CATALOG_LOGOS['cloudflare-docs'],
    handle: "cloudflare-workers",
    title: "Cloudflare Workers",
    summary: "Build Workers with storage, AI and compute bindings.",
  ...
  {
    logo: MCP_CATALOG_LOGOS['cloudflare-docs'],
    handle: "cloudflare-observability",
    title: "Cloudflare Observability",
    summary: "Inspect Worker logs and application analytics.",
